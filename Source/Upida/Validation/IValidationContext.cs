...
namespace Upida.Validation
{
    ...
    public interface IValidationContext
    {
        ...
        IFailureList Validate<T>(T target, Enum group) where T : Dtobase;

        /// <summary>
        /// Validates list of targets and returns list of failures or Null
        /// </summary>
        /// <typeparam name="T">type of object to validate</typeparam>
        /// <param name="list">list of objects to validate</param>
        /// <param name="group">validation group</param>
        /// <returns>list of failures</returns>
        IFailureList ValidateList<T>(IEnumerable<T> list, Enum group) where T : Dtobase;
        ...
        /// <returns>list of failures</returns>
        IFailureList Validate<T>(T target, Enum group, object state) where T : Dtobase;
        ...
        /// <param name="state">optional state data</param>
        /// <returns>list of failures</returns>
        IFailureList ValidateList<T>(IEnumerable<T> list, Enum group, object state) where T : Dtobase;
        ...
        /// <param name="target">object to validate</param>
        /// <param name="group">validation group</param>
        void AssertValid<T>(T target, Enum group) where T : Dtobase;

        /// <summary>
        /// Validates list of targets and throws ValidationException with list of failures
        /// </summary>
        /// <typeparam name="T">type of object to validate</typeparam>
        /// <param name="list">list of objects to validate</param>
        /// <param name="group">validation group</param>
        void AssertValidList<T>(IEnumerable<T> list, Enum group) where T : Dtobase;
        ...
        /// <param name="group">validation group</param>
        /// <param name="state">optional state data</param>
        void AssertValid<T>(T target, Enum group, object state) where T : Dtobase;
        ...
        /// <param name="group">validation group</param>
        /// <param name="state">optional state data</param>
        void AssertValidList<T>(IEnumerable<T> list, Enum group, object state) where T : Dtobase;
