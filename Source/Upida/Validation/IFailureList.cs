...
namespace Upida.Validation
{
	public interface IFailureList : IList<Failure>
	{
		...
		void Fail(string text, Severity severity);
		...
		/// <param name="text">text of the failure</param>
		/// <param name="severity">severity of the failure</param>
		void Fail(string key, string text, Severity severity);
		...
		/// <param name="text">text of the failure</param>
		void FailIf(bool condition, string text);
		...
		/// <param name="text">text of the failure</param>
		/// <param name="severity">severity of the failure</param>
		void FailIf(bool condition, string text, Severity severity);
		...
		/// <param name="text">text of the failure</param>
		/// <param name="severity">severity of the failure</param>
		void FailIf(bool condition, string key, string text, Severity severity);
	}
}