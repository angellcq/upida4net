...
namespace Upida.Validation
{
        ...
        where T : Dtobase
    {
        ...
        /// <typeparam name="R">validation group type</typeparam>
        /// <param name="group">validation group</param>
        /// <param name="state">validation state</param>
        /// <returns></returns>
        public virtual void Nested<R>(Enum group, object state = null)
            where R : Dtobase
        {
            ...
            if (null != nestedValidator)
            {
                ...
                nestedValidator.Validate(group, state);
            }
            else
            {
        ...
        /// <param name="state">validation state</param>
        /// <returns></returns>
        public virtual void NestedList<R>(Enum group, object state = null)
            where R : Dtobase
        {
            if (this.stopped) return;
        ...
        public virtual void FailRoot(string msg, Severity severity)
        {
            this.Fail(new Failure(null, msg, severity));
        }
        ...
        /// <param name="msg">failure message</param>
        public virtual void FailNested(string nestedField, string msg)
        {
            this.Fail(new Failure(string.Concat(this.path, this.name, ".", nestedField), msg, this.severity));
            this.validField = false;
        }
        ...
        /// <param name="nestedField">child property</param>
        /// <param name="msg">failure message</param>
        public virtual void FailNested(int index, string nestedField, string msg)
        {
            this.Fail(new Failure(string.Concat(this.path, this.name, "[", index, "].", nestedField), msg, this.severity));
            this.validField = false;
        }
        ...
        public abstract void Validate(Enum group, object state);
    }
}